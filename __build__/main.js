...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libComponentsHistoslider = __webpack_require__(158);
	...
	var Histoslider = (function (_Component) {
	  ...
	  _createClass(Histoslider, [{
	    ...
	    value: function render() {
	      ...
	      var selectionSorted = _d3Arrays2['default'].extent(selection);
	...
	var Histogram = (function (_Component) {
	  ...
	  _createClass(Histogram, [{
	    ...
	    value: function bucket(data, start, end, bucketSize) {
	      var sorted = data.sort(_d3Arrays2['default'].ascending);
	      var buckets = [];
	      var s = start;
	      var i = 0;
	      var max = 0;
